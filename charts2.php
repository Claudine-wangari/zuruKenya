...
<body>
    ...
    <center>
        <h3 style="margin-top:60px;">Amount Made per Month</h3></center>

    <form action="charts2.php" method="post" style="text-align:center;">
    ...
    <?php
        if(!empty($_POST))
        {
            ...
            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '01%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $jan = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '02%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $feb = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '03%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $mar = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '04%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $apr = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '05%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $may = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '06%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $june = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '07%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $july = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '08%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $aug = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '09%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $sep = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '10%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $oct = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '11%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $nov = $row['total'];
            mysqli_free_result($result);

            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '12%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $dec = $row['total'];
            mysqli_free_result($result);
        ...
        //Statistics for the year
            $sql = "SELECT SUM(total_price) AS 'total' FROM tickets WHERE date LIKE '%$year'";
            $result = mysqli_query($db, $sql);
            $row = mysqli_fetch_assoc($result); 
            $tot = $row['total'];
            mysqli_free_result($result);
